...
```{r}
tabsetPanel(
  tabPanel("Norway routine", plot_data_by_country_interactive(total_data, country = "Norway_routine")),
  tabPanel("Norway historic", plot_data_by_country_interactive(total_data, country = "Norway_historic")),
  tabPanel("Maela", plot_data_by_country_interactive(total_data, country = "Maela")),
  tabPanel("South Africa", plot_data_by_country_interactive(total_data, country = "South Africa")),
  tabPanel("Massachusetts", plot_data_by_country_interactive(total_data, country = "Massachusetts")),
  tabPanel("USA", plot_data_by_country_interactive(total_data, country = "USA")),
  type="pills"
)
```
...
# plot_MIC_by_country(total_data, "Norway_historic")
# plot_MIC_by_country(total_data, "Norway_routine")
# plot_MIC_by_country(total_data, "Maela")
# plot_MIC_by_country(total_data, "South Africa")
# plot_MIC_by_country(total_data, "Massachusetts")
# plot_MIC_by_country(total_data, "USA")
